...
static void init_rc_in()
{
	...
	g.channel_roll.set_angle(SERVO_MAX);    // 4500
...
#else
	g.channel_throttle.set_range(0, 1000);
#endif
...
#if CONFIG_APM_HARDWARE == APM_HARDWARE_PIRATES
	g.channel_roll.set_type(RC_CHANNEL_ANGLE_RAW);
	g.channel_pitch.set_type(RC_CHANNEL_ANGLE_RAW);
	g.channel_rudder.set_type(RC_CHANNEL_ANGLE_RAW);
