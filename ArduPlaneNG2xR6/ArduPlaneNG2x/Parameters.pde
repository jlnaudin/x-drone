...
static const AP_Param::Info var_info[] PROGMEM = {
 ...
 // ************************************************************
        ...
        GSCALAR(gsboost,                "TP_GSBOOST"),
        GSCALAR(closed_loop_nav,        "TP_CL_NAV"),
        GSCALAR(auto_wp_radius,         "TP_AWPR_NAV"),
        GSCALAR(nudgeoffset,            "TP_NUDGE"),
        GSCALAR(agl_ref,                "TP_AGL_REF"),
        GSCALAR(msl_ref,                "TP_MSL_REF"),    
        GSCALAR(eglider,                "TP_E_GLIDER"),     
