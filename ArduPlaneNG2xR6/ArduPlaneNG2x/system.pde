...
static void init_ardupilot()
{
	...
	#endif
#else
                Serial1.begin(SERIAL2_BAUD, 128, 16);
#endif
...
*/
	...
	// Do GPS init
	g_gps = &g_gps_driver;
	g_gps->init(GPS::GPS_ENGINE_AIRBORNE_4G);			// GPS Initialization
