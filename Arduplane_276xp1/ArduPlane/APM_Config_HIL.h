...
#define AOR                 0           // AOR angle Of Roll in degree required for the ASK21 on Xplane 9
...
#define AGL_REF        0              // Ground altitude (in m) for the AGL reference in HIL mode only
#define DELTA_ALT      3000             // delta altitude (in cm) below the route under the engin is used

#define YAW_TURN_GAIN  10

#define ALTITUDE_MIX		1       // use barometer altitude ( mix = 1 ), if 0 use gps altitude
...
//
#define SERVO_ROLL_P        0.6  // 0.6
#define SERVO_ROLL_I        0.0
#define SERVO_ROLL_D        0.0
#define SERVO_ROLL_INT_MAX  5
#define ROLL_SLEW_LIMIT     0
#define SERVO_PITCH_P       0.6   //0.8
#define SERVO_PITCH_I       0.0
#define SERVO_PITCH_D       0.0
#define SERVO_PITCH_INT_MAX 5
#define PITCH_COMP          0.18  //0.2
...
#define NAV_PITCH_ASP_P     0.8 //0.70
#define NAV_PITCH_ASP_I     0.0
#define NAV_PITCH_ASP_D     0.0
#define NAV_PITCH_ASP_INT_MAX 5

#define NAV_PITCH_ALT_P     0.75 // 0.75
...
// users to start using the APM without running the WaypointWriter first.
//
#define WP_RADIUS_DEFAULT       20   // meters
#define LOITER_RADIUS_DEFAULT	40   // 60
