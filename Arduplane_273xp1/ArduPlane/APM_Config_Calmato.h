//  CONFIG FILE FOR the CALMATO ALPHA 40 by Jean-Louis Naudin
//
...
#define SLOPE_THERMAL         DISABLED
#define AUTO_THERMAL          DISABLED
#define STAB_THERMAL          DISABLED

#define AOA	  	    5		// AOA in degree
...
// light aircraft.
//
#define AIRSPEED_CRUISE     13 
#define GSBOOST             0   // boost the throttle if ground speed is too low in case of windy conditions // 100
#define NUDGE_OFFSET	    0     //1603  // nudge_offset to get a good sustained speed in autonomous flight
#define MIN_GNDSPEED        12
